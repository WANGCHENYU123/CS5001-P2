/**
 * This class is for conducting opeartions about monkey, it extends Consumers class
 */
public class Monkey extends Consumers {
	...
	public Monkey(Grid grid, int xCoordinate, int yCoordinate) {
		super(grid);
		...
		if (checkNT()) {
			if (getStock() >= 8) {
				...
				if(timeStep.getValue() % 4 == 0) {
					...
					grid.recordConsumption(5);
					grid.reduceStockAt(xCoordinate, yCoordinate, 5);
				}
			}
		}
